...
public class MQLAppState {
   ...
   public func setValues(){
        ...
        if let retrievedEmail: String = SecureUserDefaults.getDecrypted(String.self, forKey: LocalStorageKeys.emailOrUsername) {
        ...
        if let retrievedPassword: String = SecureUserDefaults.getDecrypted(String.self, forKey: LocalStorageKeys.password) {
        ...
        if let retrievedToken: String = SecureUserDefaults.getDecrypted(String.self, forKey: LocalStorageKeys.token) {
        ...
        if let retrievedAppleIdEmail: String = SecureUserDefaults.getDecrypted(String.self, forKey: LocalStorageKeys.appleIdEmail) {
        ...
        if let retrievedAppleIdFullname: String = SecureUserDefaults.getDecrypted(String.self, forKey: LocalStorageKeys.appleIdFullname) {
